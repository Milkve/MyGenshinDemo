...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp6(long p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(Managers.QuestManager.NpcQuestStatus p0, Managers.QuestManager.NpcQuestStatus p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(UI.Common.UIGroup.UIState p0, UI.Common.UIGroup.UIState p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, int>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Action<long>))
			{
			    return new System.Action<long>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Action<Managers.QuestManager.NpcQuestStatus, Managers.QuestManager.NpcQuestStatus>))
			{
			    return new System.Action<Managers.QuestManager.NpcQuestStatus, Managers.QuestManager.NpcQuestStatus>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<UI.Common.UIGroup.UIState, UI.Common.UIGroup.UIState>))
			{
