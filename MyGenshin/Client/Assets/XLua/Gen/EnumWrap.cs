...
namespace XLua.CSObjectWrap
{
    ...
    public class SkillBridgeMessageResultWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(SkillBridge.Message.Result), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(SkillBridge.Message.Result), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(SkillBridge.Message.Result), L, null, 3, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Success", SkillBridge.Message.Result.Success);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Failed", SkillBridge.Message.Result.Failed);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(SkillBridge.Message.Result), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushSkillBridgeMessageResult(L, (SkillBridge.Message.Result)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushSkillBridgeMessageResult(L, SkillBridge.Message.Result.Success);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Failed"))
                {
                    translator.PushSkillBridgeMessageResult(L, SkillBridge.Message.Result.Failed);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for SkillBridge.Message.Result!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for SkillBridge.Message.Result! Expect number or string, got + " + lua_type);
            }
